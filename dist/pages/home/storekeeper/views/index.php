...
<body>
				...
				<section class="row">
							...
							<div class="col-12">
								<div class="card" id="profile">
									<div class="card-header" id="cardHeader">
										<h4>Ordenes de compras por mes</h4>
									</div>
									<div class="card-body">
										<div id="chart-orders-for-month"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-12 col-lg-3">
						...
						<div class="card" id="profile">
							...
							<div class="card-body">
								<div id="chart-products-for-category"></div>
							</div>
						</div>
					</div>
				</section>
	...
	<script type="module" src="./../controllers/categoryProducts.js"></script>
	<script type="module" src="./../controllers/qtyPurchaseOrders.js"></script>
</body>
