                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Página donde podremos vizualizar la lista de ordenes
                                con las que contamos, podrás ver, eliminar y buscar una orden en específica.
                            </p>
                        </div>
