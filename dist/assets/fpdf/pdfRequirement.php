...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      if(isset($_GET['id'])) {
         ...
         $consulta_info = $conn->prepare("SELECT * FROM VIEW_REQUIREMENT WHERE id = ?");
      ...
      $this->Cell(90, 10, utf8_decode("ID Encargado : " . $dato_info->id_user), 0, 0, '', 0);
      $this->Cell(90, 10, utf8_decode("Encargado : " . $dato_info->name), 0, 0, '', 0);
      $this->Ln(7);
      ...
      $this->Cell(90, 10, utf8_decode("Descripción : " . $dato_info->description), 0, 0, '', 0);
      $this->Ln(7);
      ...
      $this->Cell(100, 10, utf8_decode("Productos del Requerimiento de compra"), 0, 1, '', 0);
      $this->Ln(1);
   ...
   function Footer()
   {
      ...
      $this->Cell(94, 5, utf8_decode('Monto del Requerimiento de Compra:'), 0, 0, 'L', 0); 
