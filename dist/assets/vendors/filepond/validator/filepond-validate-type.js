		...
		addFilter('LOAD_FILE', function (file, _ref3) {
			...
			return new Promise(function (resolve, reject) {
				...
				var handleRejection = function handleRejection() {
					...
					var acceptedFileTypesMapped_unique =
						acceptedFileTypesMapped.filter(function (item, index) {
							return (
								acceptedFileTypesMapped.indexOf(item) === index
							);
						});
		...
		return {
			...
			options: {
				...
				labelFileTypeNotAllowed: [
					'La imagen no es de tipo válido',
					Type.STRING,
				],

				// nicer label
				fileValidateTypeLabelExpectedTypes: [
					'Esperando {allButLastType} o {lastType}',
					Type.STRING,
				],
